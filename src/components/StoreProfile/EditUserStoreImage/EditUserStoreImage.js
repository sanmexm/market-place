...
const EditUserStoreImage = () => {
    ...
    const [productImg, setProductImg]                       = useState(singleStore?.selectedFile);
    const [selectedFileErrors, setSelectedFileErrors]       = useState(null);
    const [errorMessage, setErrorMessage]                   = useState(null);
    
    const [ postData, setPostData ]                         = useState({selectedFile: singleStore?.selectedFile || ''})
